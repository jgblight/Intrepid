...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'intrepid_app_location', 'name')
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Location.name'
        db.add_column(u'intrepid_app_location', 'name',
    ...
    models = {
        ...
        u'intrepid_app.pin': {
            ...
            'pin_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 13, 0, 0)'}),
